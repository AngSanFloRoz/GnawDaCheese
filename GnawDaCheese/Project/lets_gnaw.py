...
class Cheese:
    ...
    def save_to_xlsx(self, xlsx_filename: str, json_filename: str = None):
        ...
        try:
            ...
            with pandas.ExcelWriter(xlsx_filename, engine="openpyxl") as writer:
                ...
                if titles:
                    ...
                    df_titles.to_excel(writer, sheet_name = "Títulos", index = False)
                ...
                if paragraphs:
                    ...
                    df_paragraphs.to_excel(writer, sheet_name = "Párrafos", index=False)
...
if __name__ == "__main__":
    ...
    cheddar.save_to_json("Presidentes_USA.json")
    cheddar.save_to_xlsx("Presidentes_USA.xlsx", "Presidentes_USA.json")
    mozzarella.save_to_json("mozzarella_data.json")
    mozzarella.save_to_xlsx("mozzarella_data.xlsx", "mozzarella_data.json")
